      ...
      <div className="container mt-5">
        <div className="row row-cols-1 row-cols-md-2 g-4">
          {produtosCarrinho.map(produto => (
            <div key={produto.id_produto_mercado} className="col mb-4">
              <div className="card h-100">
                <img className="card-img-top carrinho-img" src={`http://localhost:5000/img/${produto.foto_produto}`} alt={produto.nome_produto} />
                <div className="card-body">
                  <h4 className="card-title carrinho-title">{produto.nome_produto}</h4>
                  <h6 className="card-subtitle mb-2 text-muted carrinho-subtitle">{produto.marca_produto}</h6>
                  <p className="card-text carrinho-price">Preço: R$ {produto.preco_produto}</p>
